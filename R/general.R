...
#' #                         trt = rbinom(50, 1, 0.5),
#' #                         out = rnorm(50, 1, 0.2))
#' # create_post_jointVIP(new_jointVIP, post_data)
...
#' @examples
#' # not run
#' # new_jointVIP = create_jointVIP(treatment, outcome,
#' #                                covariates,
#' #                                pilot_df, analysis_df)
#'
#' # plot(new_jointVIP, smd='OVB-based', use_abs=TRUE)
