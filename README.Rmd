...
Joint variable importance plot (jointVIP) visualizes each variable's outcome importance via Pearson's correlation and treatment importance via omitted variable bias-based standardized mean differences. Bias curves enable comparisons to support prioritization.

## Installation

You can install the development version of jointVIP from [GitHub](https://github.com/) with:
